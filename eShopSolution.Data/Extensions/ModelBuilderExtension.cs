    ...
    public static class ModelBuilderExtension
    {
        public static void Send(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CategoryTranslation>().HasData(
                    new CategoryTranslation() { Id = 1, CategoryId = 1, Name = "Áo nam", LanguageId = "vi-VN", SeoAlias = "ao-nam", SeoDescription = "Sản phẩm áo thời trang cho nam", SeoTitle = "Sản phẩm áo thời trang cho nam" },
                        ...
                        new CategoryTranslation() { Id = 3, CategoryId = 2, Name = "Áo nữ", LanguageId = "vi-VN", SeoAlias = "ao-nu", SeoDescription = "Sản phẩm áo thời trang cho nữ", SeoTitle = "Sản phẩm áo thời trang cho nữ" },
            ...
            var roleId = new Guid("c843c1b3-1d86-4206-9dab-ce1ae95a2c52");
            var adminId = new Guid("9c824d6a-1d71-4eb3-b56e-c0bd62f28a5e");
